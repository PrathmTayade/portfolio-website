...
const Footer = () => {
  return (
    <footer className="w-full border-t-2  border-dark py-6 dark:border-light dark:bg-dark dark:text-light">
      <div className="container mx-auto space-y-2 divide-y divide-gray-400 divide-opacity-50 px-6 ">
        <div className=" pb-1 md:col-span-6 md:pb-0">
          <Link
            rel="noopener noreferrer"
            href="#"
            className="flex justify-center space-x-3 md:justify-start"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full dark:bg-primary">
              <svg
